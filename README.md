...
- [What is BITS?](#what-is-bits)
    - [* Centralized system logging](#-centralized-system-logging)
...
- [Base APIs](#base-apis)
    ...
    - [Helper](#helper)
    - [Others](#others)
    - [Base is constantly being developed and improved. The base has a file called bits-base.js where all of bases APIs are added to the global. Check here for all current helpers and APIs for your modules to use.](#base-is-constantly-being-developed-and-improved-the-base-has-a-file-called-bits-basejs-where-all-of-bases-apis-are-added-to-the-global-check-here-for-all-current-helpers-and-apis-for-your-modules-to-use)
