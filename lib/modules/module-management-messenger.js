...
(() => {
  ...
  class ModuleManagementMessenger extends Messenger {
    constructor(manager) {
      super();

      this._eventEmitter = new EventEmitter();
      this._manager = manager;
      this.addEventListener(LOAD_PROCESS_FINISH_EVENT, null, this._loadComplete.bind(this));
    }
  ...
  module.exports = ModuleManagementMessenger;
})();
