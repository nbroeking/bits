...
(() => {
  ...
  class ModuleManager extends CrudManager {
    constructor(scopeManager, cryptoManager, userManager, loggingManager, galleryItemManager, widgetManager, pageItemManager) {
      super(TAG, {readScopes: ['base'], writeScopes: ['base'], Messenger: require('./module-messenger'), Router: require('./modules-router'), routePath: '/api/base/modules'});
    ...
    installModule(modPath) {
      console.log('Installing Module', modPath);
    }
