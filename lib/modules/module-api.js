...
(() => {
  ...
  class ModuleApi extends CrudApi {
    ...
    addModulesLoadedListener(listener) {
      return this._messageCenter.addEventListener(ModuleConstants.EVENT.LOADED, {scopes: scopes}, listener);
    }

    removeModulesLoadedListener(listener) {
      return this._messageCenter.removeEventListener(ModuleConstants.EVENT.LOADED, {scopes: scopes}, listener);
    }
  }
