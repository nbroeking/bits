...
(() => {
  ...
  class ModuleApi {
    ...
    addUpgradeStartingListener(listener, {scopes=this._scopes}={}) {
      return this._messageCenter.addEventListener(ModuleConstants.EVENT.UPGRADE_STARTING, scopes, listener);
    }

    removeUpgradeStartingListener(listener) {
      return this._messageCenter.removeEventListener(ModuleConstants.EVENT.UPGRADE_STARTING, listener);
    }
  }
