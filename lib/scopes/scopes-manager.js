...
(() => {
  ...
  class ScopesManager extends EventEmitter {
    ...
    static get SCOPE_ACCOUNT() {
      return Object.assign({}, STATIC_SCOPES.account);
    }

    static get SCOPE_BASE() {
      return Object.assign({}, STATIC_SCOPES.base);
    }

    static get SCOPE_PUBLIC() {
      return Object.assign({}, STATIC_SCOPES.public);
    }

    static get STATIC_SCOPES() {
      return Object.assign({}, STATIC_SCOPES);
    }
  }
