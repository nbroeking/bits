  ...
  */
  ...
  class Base extends EventEmitter {
    ...
    initialize() {
      ...
      this._moduleManager = new ModuleManager(this._scopeManager, this._cryptoManager,
        this._userManager, this._loggingManager,
        this._galleryItemManager, this._homeManager.getWidgetManager(),
        this._pageItemManager, this._keyManager);
    ...
    load() {
      ...
      .then(() => this._messageCenter.sendEvent('base#Base initialized', {scopes: null})); //Damn it Nic: TODO: Dont do this. A messenger should be used
    }
