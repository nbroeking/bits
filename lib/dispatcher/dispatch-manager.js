...
(() => {
  ...
  const ModuleManagementApi = require('../modules/module-management-api');
  ...
  class Dispatcher {
    ...
    load(messageCenter) {
      this._moduleApi = new ModuleManagementApi(messageCenter, this._module);
    ...
    _dispatchModule() {
      ...
      .catch((err) => {
        ...
        return this._moduleApi.loadComplete({err: {message: err.message}})
